"""
From here https://raw.githubusercontent.com/shubham-goel/ds/2ef898894abb33c82e73790eedf30995ddc9d1c1/src/data/blender-preprocess-uvunwrap.py
...
in_file = sys.argv[
    sys.argv.index("--") + 1
]  # '../dummy_data/blender_test/B002JAYMEE.obj'
out_file = sys.argv[
    sys.argv.index("--") + 2
]  # '../dummy_data/blender_test/B002JAYMEE_uv.obj'
